...
export class IdDocumentComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.idDocumentService
      ...
      .subscribe(
        (res: HttpResponse<IIdDocument[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInIdDocuments(): void {
    this.eventSubscriber = this.eventManager.subscribe('idDocumentListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IIdDocument[] | null, headers: HttpHeaders, page: number): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    this.router.navigate(['/id-document'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
