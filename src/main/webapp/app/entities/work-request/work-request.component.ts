...
export class WorkRequestComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.workRequestService
      ...
      .subscribe(
        (res: HttpResponse<IWorkRequest[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInWorkRequests(): void {
    this.eventSubscriber = this.eventManager.subscribe('workRequestListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IWorkRequest[] | null, headers: HttpHeaders, page: number): void {
