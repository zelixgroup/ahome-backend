...
export class WorkComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.workService
      ...
      .subscribe(
        (res: HttpResponse<IWork[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInWorks(): void {
    this.eventSubscriber = this.eventManager.subscribe('workListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IWork[] | null, headers: HttpHeaders, page: number): void {
