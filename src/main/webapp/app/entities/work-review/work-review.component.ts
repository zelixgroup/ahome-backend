...
export class WorkReviewComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.workReviewService
      ...
      .subscribe(
        (res: HttpResponse<IWorkReview[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInWorkReviews(): void {
    this.eventSubscriber = this.eventManager.subscribe('workReviewListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IWorkReview[] | null, headers: HttpHeaders, page: number): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    this.router.navigate(['/work-review'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
