...
public class WorkReviewCommentResource {
    ...
    public ResponseEntity<List<WorkReviewComment>> getAllWorkReviewComments(Pageable pageable) {
        log.debug("REST request to get a page of WorkReviewComments");
        Page<WorkReviewComment> page = workReviewCommentService.findAll(pageable);
