...
public class WorkRequestStatusChangeResource {
    ...
    public List<WorkRequestStatusChange> getAllWorkRequestStatusChanges() {
        log.debug("REST request to get all WorkRequestStatusChanges");
        return workRequestStatusChangeService.findAll();
    }
